...
public class QuickperfDriver implements Driver {
    ...
    public Connection connect(String url, Properties properties) throws SQLException {
        ...
        connectionInfo.setDataSourceName(proxyDataSource.getDataSourceName());
        // the connection is not yet created so we cannot set it's ID here, but if we don't it's null
        // and create issue when serializing the ExecutionInfo
        connectionInfo.setConnectionId("");
